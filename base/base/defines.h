...
#if !defined(__x86_64__) && !defined(__aarch64__) && !defined(__PPC__) && !(defined(__riscv) && (__riscv_xlen == 64)) && !(__loongarch64)
#    error "The only supported platforms are x86_64 and AArch64, PowerPC (work in progress), RISC-V 64 (experimental) And Loongarch64 (experimental)"
#endif
